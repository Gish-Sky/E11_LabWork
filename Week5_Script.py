...
while (time.time()-start_time) < 30:
    ...
    print("Start time: " + str(start_time) + ", Current time: " + str(time.time()))
...
while (now-start_time) < run_time:
    time.sleep(1)
    now = time.time()
    data_list = [now, bme680.temperature, bme680.gas, bme680.relative_humidity, bme680.pressure, bme680.altitude]
    print(data_list)
